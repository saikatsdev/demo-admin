                ...
                <div className="col-lg-3 col-12">
                    <div className="side">
                        <div className="list-group h-100">
                            {categories.map((item) => (
                                <button key={item} onClick={() => setActive(item)} className={`list-group-item list-group-item-action d-flex align-items-center gap-2 ${
                                    active === item ? "active" : ""}`}>
                        ...
                        {tutorialGroups[active].map((video, index) => (
                            <div className="video-card" key={index}>
                                ...
                                <div className="video-box">
                                    <iframe src={video} title={`video-${index}`} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                                </div>
                            </div>
                        ))}
                    </div>
