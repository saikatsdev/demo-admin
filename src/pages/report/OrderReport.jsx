...
export default function OrderReport() {
    ...
    const filteredData = orders.filter((item) => (item.phone_number.toLowerCase().includes(filter.toLowerCase()) || item.current_status.name.toLowerCase().includes(filter.toLowerCase()) || item?.order_from?.name.toLowerCase().includes(filter.toLowerCase()))
    );
