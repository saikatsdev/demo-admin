...
export default function CourierReport() {
    ...
    const filteredOrders = orders?.filter((order) => {
        ...
        return (order.courier_id.toLowerCase().includes(term));
    });
        ...
        <>
            <div className="reportWrapper">
                ...
                <Space style={{marginBottom: 16,display: "flex",justifyContent: "space-between",alignItems: "center"}} wrap>
                    <Space wrap>
                        <Input.Search placeholder="Search by courier name ..." allowClear value={localSearch} onChange={(e) => setLocalSearch(e.target.value)} style={{ width: 300 }}/>
