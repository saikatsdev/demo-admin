        ...
        <>
            ...
            <div className="pagehead">
                ...
                <div className="head-actions">
                    <Breadcrumb items={[{ title: <Link to="/dashboard">Dashboard</Link> },{ title: "Add Product Catelogs" },]}/>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div style={{ width: "60%" }}>
                            <Form.Item name="categories" label="Categories" rules={[{ required: true }]}>
                                <Select mode="multiple" showSearch optionFilterProp="label" options={categories} placeholder="Select One" onChange={handleCategoryChange}/>
                            </Form.Item>
                        </div>
