...
import { ArrowLeft, Package, Layers, Settings2, RefreshCcw, CheckCircle2, LayoutGrid } from "lucide-react";
            ...
            <div style={{ display: "flex", gap: "24px", flexDirection: "column"}}>
                ...
                >
                    <div style={{ marginBottom: "24px" }}>
                        <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "8px", color: "#1a1a1a" }}>Catalog Configuration</h2>
                        <p style={{ color: "#666", fontSize: "14px" }}>Update your product catalog settings for Facebook Feed integration. Changes will be reflected in the XML feed after saving.</p>
                    </div>
                ...
                >
                    <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
                        ...
                        <div>
                            <h3 style={{ fontSize: "16px", fontWeight: "600", color: "#003a8c", margin: "0 0 4px 0" }}>Sync Status</h3>
                            <p style={{ color: "#0050b3", fontSize: "13px", margin: 0 }}>
                                Updating your catalog will regenerate the XML feed URL. If you have already added this feed to Facebook Commerce Manager, it will automatically pull the updated product data during its next scheduled sync.
                            </p>
                        </div>
                    </div>
                </Card>
