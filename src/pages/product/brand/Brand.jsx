...
import { Input as AntInput, Breadcrumb, Button, Card, Form, Modal, Popconfirm, Select, Space, Table, Tag, Typography, message } from "antd";
...
export default function Brand() {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space>
                    <Button type="text" icon={<EditOutlined style={{ color: '#1890ff' }} />} onClick={() => onEdit(record)} title="Edit Brand"/>
                    <Popconfirm title="Delete brand?" description="Are you sure you want to delete this brand?" okText="Yes" cancelText="No" onConfirm={() => onDelete(record.id)} okButtonProps={{ danger: true }}>
                        <Button type="text" danger icon={<DeleteOutlined />} title="Delete Brand" />
                    </Popconfirm>
                </Space>
            ),
        },
        ...
        <div style={{ padding: 16 }}>
            ...
            <div className="pagehead">
                <div className="head-left">
                    ...
                    <p className="subtitle">Manage product brands and logos</p>
                </div>
