...
export default function EditMission() {
    ...
    useEffect(() => {
        const getPrivacy = async () => {
            const res = await getDatas(`/admin/missions/${id}`);
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            setLoading(true);
            const res = await postData(`/admin/missions/${id}`, formData);
        ...
        <>
            ...
            <div className="pagehead">
                <div className="head-left">
                    <h1 className="title">Update Mission</h1>
                </div>
