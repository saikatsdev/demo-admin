...
export default function Vision() {
    ...
    const onEdit = (record) => {
        navigate(`/edit/vision/${record.id}`);
    }
    ...
    useEffect(() => {
        ...
        const fetchContactList = async () => {
            ...
            const res = await getDatas("/admin/visions");
    ...
    const onDelete = async (id) => {
        const res = await deleteData(`/admin/visions/${id}`);

        if(res?.success){
            const refreshed = await getDatas("/admin/visions");
        ...
        <>
            ...
            <div className="pagehead">
                <div className="head-left">
                    <h1 className="title">Vision List</h1>
                </div>
