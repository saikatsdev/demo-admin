...
export default function AddShippingPolicy() {
    // Hook
    useTitle("Add Shipping Policy");
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            setLoading(true);
            const res = await postData("/admin/shipping/policy", formData);
        ...
        <>
            ...
            <div className="blog-form">
                <div className="form-head-wrapper">
                    <h2 className="form-head-title">Create Shipping Policy</h2>
