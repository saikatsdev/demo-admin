...
export default function AddWarrantyPolicy() {
    // Hook
    useTitle("Add Warranty Policy");
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            setLoading(true);
            const res = await postData("/admin/warranty/policy", formData);
        ...
        <>
            ...
            <div className="pagehead">
                <div className="head-left">
                    <h1 className="title">Warranty Policy</h1>
                </div>
            ...
            <div className="blog-form">
                <div className="form-head-wrapper">
                    <h2 className="form-head-title">Create Warranty Policy</h2>
