...
export default function Mission() {
    ...
    const onEdit = (record) => {
        navigate(`/edit/mission/${record.id}`);
    }
    ...
    useEffect(() => {
        ...
        const fetchContactList = async () => {
            ...
            const res = await getDatas("/admin/missions");
    ...
    const onDelete = async (id) => {
        const res = await deleteData(`/admin/missions/${id}`);

        if(res?.success){
            const refreshed = await getDatas("/admin/missions");
        ...
        <>
            ...
            <div className="pagehead">
                <div className="head-left">
                    <h1 className="title">Mission List</h1>
                </div>
