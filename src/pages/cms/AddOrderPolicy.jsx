...
export default function AddOrderPolicy() {
    // Hook
    useTitle("Add Order Policy");
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            setLoading(true);
            const res = await postData("/admin/order/policy", formData);
        ...
        <>
            ...
            <div className="pagehead">
                <div className="head-left">
                    <h1 className="title">Order Policy</h1>
                </div>
            ...
            <div className="blog-form">
                <div className="form-head-wrapper">
                    <h2 className="form-head-title">Create Order Policy</h2>
