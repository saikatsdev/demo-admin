...
export default function EditCategorySection() {
  ...
  // Fetched Category Section Data
  useEffect(() => {
    let isMounted = true;

    const fetchedSingleData = async () => {
      const res = await getDatas(`/admin/category-sections/${id}`);
  ...
  const hasCategories = form.getFieldValue("sections") || [];
    ...
    <>
      ...
      <div className="pagehead">
        <div className="head-left">
          <h1 className="title">Edit Category Section</h1>
        </div>
      ...
      <div className="category-section-form-wrapper">
        <Form layout="vertical" form={form} onFinish={handleSubmit}>
          ...
          >
            {hasCategories.map((section, index) => (
              <div key={section.id}>
