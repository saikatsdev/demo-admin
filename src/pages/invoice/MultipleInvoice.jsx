// src/pages/Invoice/MultipleInvoices.jsx
...
const InvoiceA4 = ({ order, settings }) => {
  ...
  return (
    <div
      className="invoice-a4 invoice-section"
      style={{
        background: "white",
        margin: "40px auto",
        padding: "15px",
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px" }}>
        <div style={{ display: "flex", alignItems: "flex-start" }}>
          ...
          <div style={{ marginLeft: "16px", fontSize: "14px", lineHeight: 1.35 }}>
            ...
            <p style={{ marginBottom: "5px" }}>Contact: {settings.phoneNumber}</p>
        ...
        <div>
          <table style={{ borderCollapse: "collapse", width: "auto", minWidth: 250, fontWeight: 600, fontSize: 14 }}>
            <tbody>
              <tr>
                ...
                <td style={{ border: `1px solid ${BC}`, padding: 5 }}>{order?.invoice_number || `PNP/000${order?.id}`}</td>
              </tr>
              <tr>
          ...
          {order?.id ? (
            <div style={{ textAlign: "center", marginTop: 10 }}>
              <Barcode value={String(order.id)} format="CODE128" displayValue={false} height={40} width={3} margin={0} background="#fff" lineColor="#000" />
              <small style={{ color: "#6c757d", display: "block" }}>{order?.id}</small>
            </div>
          ) : null}
        </div>
      </div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
        ...
        <tbody>
          {(order?.details || []).map((item, idx) => (
            <tr key={idx}>
              ...
              <td style={{ border: `1px solid ${BC}`, padding: 8, lineHeight: 1.35 }}>
                {item?.product?.name}
                {item?.attribute_value_1 && <small style={{ display: "block", color: "#6c757d" }}>[{item?.attribute_value_1?.attribute?.name}: {item?.attribute_value_1?.value}]</small>}
                {item?.attribute_value_2 && <small style={{ display: "block", color: "#6c757d" }}>[{item?.attribute_value_2?.attribute?.name}: {item?.attribute_value_2?.value}]</small>}
                {item?.attribute_value_3 && <small style={{ display: "block", color: "#6c757d" }}>[{item?.attribute_value_3?.attribute?.name}: {item?.attribute_value_3?.value}]</small>}
              </td>
              ...
              <td style={{ border: `1px solid ${BC}`, textAlign: "right", paddingRight: 10 }}>{item?.mrp} Tk</td>
              <td style={{ border: `1px solid ${BC}`, textAlign: "right", paddingRight: 10 }}>
                {(Number(item?.mrp) || 0) * (Number(item?.quantity) || 0)} Tk
              </td>
            </tr>
          ))}
          <tr>
            ...
            <td style={{ border: `1px solid ${BC}`, textAlign: "right", paddingRight: 10 }}>{order?.mrp} Tk</td>
          </tr>
          <tr>
            <td colSpan="5" className="t-empty"></td>
          ...
          <tr>
            ...
            <td style={{ border: `1px solid ${BC}`, textAlign: "right", paddingRight: 10 }}>{order?.payable_price} Tk</td>
          </tr>
        </tbody>
      </table>
      ...
      <div style={{ textAlign: "center", marginTop: 12 }}>
        <div style={{ fontWeight:600, fontSize:11, textAlign:"start", }}>Customer Note: {order?.note }</div>
...
const InvoiceA5 = ({ order, settings }) => {
  ...
  return (
    <div
      className="invoice-a5 invoice-section"
      style={{
        background: "white",
        margin: "0 auto 35px",
        padding: "12px",
        ...
        <div>
          <table style={{ borderCollapse: "collapse", width: "auto", minWidth: 200, fontWeight: 600, fontSize: 12 }}>
            <tbody>
              <tr>
                ...
                <td style={{ border: `1px solid ${BC}`, padding: 4 }}>{order?.invoice_number || `PNP/000${order?.id}`}</td>
              </tr>
              <tr>
          ...
          {order?.id ? (
            <div style={{ textAlign: "center", marginTop: 6 }}>
              <Barcode value={String(order.id)} format="CODE128" displayValue={false} height={35} width={2.5} margin={0} background="#fff" lineColor="#000" />
              {/* <small style={{ color: "#6c757d", fontSize: 10, display: "block" }}>{order?.id}</small> */}
            </div>
          ) : null}
        </div>
      </div>
        ...
        <thead>
          <tr>
            {["Sl#", "Image", "Description", "SKU", "Qty", "Unit Price", "Total"].map((h, i) => (
              <th
                key={i}
                style={{ border: `1px solid ${BC}`, padding: "6px 6px", fontSize: 11, background: "#f5f5f5", textAlign: "center" }}
              >
                {h}
              </th>
            ))}
        ...
        <tbody>
          {(order?.details || []).map((item, index) => (
            <tr key={index}>
              ...
              <td style={{ border: `1px solid ${BC}`, textAlign: "right", fontSize: 11, paddingRight: 10 }}>{item?.mrp} Tk</td>
          ...
          <tr>
            ...
            <td style={{ border: `1px solid ${BC}`, textAlign: "right", fontSize: 11, paddingRight: 10 }}>{order?.mrp} Tk</td>
          </tr>
          <tr>
            <td colSpan="5" className="t-empty"></td>
            <td style={{ border: `1px solid ${BC}`, textAlign: "right", fontWeight: 600, fontSize: 11, paddingRight: 10 }}>Delivery</td>
          ...
          <tr>
            ...
            <td style={{ border: `1px solid ${BC}`, textAlign: "right", fontSize: 11, paddingRight: 10 }}>{order?.payable_price} Tk</td>
          </tr>
        </tbody>
      </table>

      <div style={{ fontWeight: 600, fontSize: 11, marginTop: 8 }}>In Words: {totalPriceInWords}</div>
...
const InvoicePos = ({ order, settings }) => {
  ...
  return (
    <div
      className="invoice-pos invoice-section"
      style={{
    ...
    >
      ...
      <div className="pos-hasher" style={{ textAlign: "center",}}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
          ...
          <div style={{ textAlign: "center" }}>
            {order?.id ? (
              <Barcode value={String(order.id)} format="CODE128" displayValue={false} height={30} width={1.8} margin={0} background="#fff" lineColor="#000" />
            ) : null}
      ...
      <table style={{ width: "100%", fontSize: 12,  marginBottom: 5, }}>
        <tbody>
          <tr>
            <td>Invoice:</td>
            <td style={{ textAlign: "right" }}>{order?.invoice_number || `PNP/000${order?.id}`}</td>
          </tr>
          <tr>
            <td>Date:</td>
        ...
        <tbody>
          {(order?.details || []).map((item, i) => (
            <tr key={i}>
              ...
              <td style={{ textAlign: "right" }}>{(Number(item?.mrp) || 0) * (Number(item?.quantity) || 0)} Tk</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <table style={{ width: "100%", fontSize: 12, marginTop: 5 }}>
        <tbody>
          <tr>
            <td>Subtotal:</td>
            <td style={{ textAlign: "right" }}>{order?.mrp} Tk</td>
          </tr>
          <tr>
            <td>Delivery:</td>
          ...
          <tr>
            ...
            <td style={{ textAlign: "right" }}>
              <strong>{order?.payable_price} Tk</strong>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <div style={{ fontWeight:600, fontSize:11, textAlign:"start", }}>Customer Note: {order?.note }</div>
      <div style={{ fontWeight:600, fontSize:11, textAlign:"start", }}> Company Note: <span style={{fontSize:10}}>{settings?.invoiceText || "প্রোডাক্ট হাতে পেয়ে কুরিয়ার ম্যানের সামনে চেক করে নিন। কোনো সমস্যা থাকলে সাথে সাথে আমাদের কল সেন্টারে জানান।"}</span></div>
...
const MultipleInvoices = () => {
  ...
  const [activeLayout, setActiveLayout] = useState("A4"); // "A4" | "A5" | "POS"
  const [orders, setOrders] = useState([]);
  const [settings, setSettings] = useState({ title: "", logo: "", phoneNumber: "", address: "", email: "" });
  const [isDownloading, setIsDownloading] = useState(false);
  const [loading, setLoading] = useState(true);

  // Parse ids from query ?orders=1,2,3
  ...
  const fetchSettings = async () => {
    ...
    if (res?.success) {
      const s = { title: "", logo: "", phoneNumber: "", address: "", email: "", invoiceText:"", };
      (res?.result?.data || []).forEach((item) => {
        if (item?.key === "title") s.title = item?.value || s.title;
        if (item?.key === "footer_logo" || item?.key === "header_logo" || item?.key === "logo") s.logo = item?.value || s.logo;
        if (item?.key === "phone_number") s.phoneNumber = item?.value || s.phoneNumber;
        if (item?.key === "footer_address" || item?.key === "address") s.address = item?.value || s.address;
        if (item?.key === "footer_email" || item?.key === "email") s.email = item?.value || s.email;
        if (item?.key === "invoice_text" || item?.key === "invoice_text") s.invoiceText = item?.value || s.invoiceText;
      });
      setSettings(s);
    }
  };
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      try { await Promise.all([fetchSettings(), fetchOrders()]); } finally { setLoading(false); }
    })();
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Clone nodes inside the container
      ...
      /* === CORS-safe logo swap only on clones (UI untouched) === */
      ...
      for (const c of clones) {
        ...
        logos.forEach((img) => {
          if (logoSrcForCanvas) {
            ...
            img.loading = "eager";
            img.decoding = "sync";
            img.src = logoSrcForCanvas; // same-origin proxy বা weserv URL
          }
        });
  ...
  return (
    <div style={{ background: "#fff", color: "black", padding: 10 }}>
      ...
      <div className="no-print" style={{ display: "flex", justifyContent: "space-between", marginBottom: 15, alignItems: "center" }}>
        ...
        <div>
          <button
            ...
            style={{ backgroundColor: "#1C558B", border: "1px solid #000", borderRadius: 3, padding: "6px 16px", fontWeight: 600, marginRight: 10, cursor: "pointer" }}
          >
            {isDownloading ? "Generating..." : "Download PDF"}
          </button>
          <button onClick={handlePrint} style={{ backgroundColor: "#e2e2e2", border: "1px solid #000", borderRadius: 3, padding: "6px 16px", fontWeight: 600, cursor: "pointer" }}>
            Print
          </button>
        </div>
      </div>
      ...
      <div
        id="print-section"
        className={`printable multi-print layout-${activeLayout.toLowerCase()}`}
        ref={printSectionRef}
        style={{ padding: activeLayout === "POS" ? "10px 50px 0 40px" : "0 40px" }}
      >
        {orders.map((order) => (
      ...
      <style>{`
        @media print {
          ...
          .invoice-pos { width: 80mm !important; }

          .invoice-wrapper-to-capture {
            break-inside: avoid;
          ...
          .invoice-table th, .invoice-table td { border: 1px solid #555; padding: 8px 10px; }
          .invoice-table .t-empty { border: 0 !important; padding: 0 !important; }

          /* A4: one per page */
          .layout-a4 .invoice-wrapper-to-capture { page-break-after: always; }
          .layout-a4 .invoice-wrapper-to-capture:last-child { page-break-after: auto; }

          /* A5: two per page if fits */
          .layout-a5 .invoice-wrapper-to-capture { page-break-after: auto; }
          .layout-a5 .invoice-a5 { margin: 0mm auto !important; padding: 5mm !important; }
          .layout-a5 .invoice-wrapper-to-capture::before { content: ""; display: block; height: 6mm; }

          /* POS: stacked */
          .layout-pos .invoice-wrapper-to-capture { page-break-after: auto; }
          .layout-pos .invoice-pos { margin: 4mm auto !important; }
          .layout-pos .invoice-wrapper-to-capture::before { content: ""; display: block; height: 4mm; }
        }
      `}</style>
    </div>
  );
