...
export default function CourierInfo({record,name,loading,courierData,courierDataTableShow,setCourierDataTableShow,curierDeliveryReports,localOrderSummary}) {
    ...
    [
        {
            ...
            render: (_, record) => (
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    {record.logo && (
                        <img src={record.logo} alt={record.courier_name} style={{ width: 26, height: 26, objectFit: "contain" }}/>
                    )}
    ...
    const tableDataWithTotal = useMemo(() => {
        ...
        const successPct = totals.total > 0 ? Math.round((totals.delivered / totals.total) * 100) : 0;
    ...
    return (
        <>
            <div className="customer-information" style={{ padding: "8px", width: 500 }}>
                <Row gutter={[16, 8]}>
                    <Col span={12}>
                        <div className="main-section">
                            <h4 className="fw-semibold text-secondary border-bottom pb-2 mb-2" style={{ fontSize: "20px" }}>
                        ...
                        <div className="main-section bg-white border rounded-3 shadow-sm">
                            ...
                            <div className="order-summary">
                                ...
                                },
                                {
                                    ...
                                    <div key={item.label} className="d-flex justify-content-between mb-1" style={{ fontWeight: 700 }}>
                                        <span>{item.label}:</span>
                                        <span style={{color: item.color,minWidth: 80,textAlign: "left"}}>
                                            {item.value}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="main-section">
                            {loading ? (
                                ...
                                <div className="customer-delivery-success-rate">
                                    <Row gutter={[16, 0]} justify="space-between" align="middle">
                                        <Col span={24}>
                                            <div className="courier-info-dis">
                                                ...
                                                <div className="customer-delivery-success-btn" style={{ display: "flex", gap: "8px" }}>
                                                    <Button size="small" style={{backgroundColor: "#1C558B",color: "white",padding: "3px 10px 5px 10px",}}>
                                                        Re-Check
                                                    </Button>

                                                    <Button size="small" style={{color: "#1C558B",padding: "3px 10px 5px 10px",}} onClick={() =>setCourierDataTableShow(!courierDataTableShow)}>
                                    ...
                                    {courierDataTableShow && courierData && courierData.length > 0 && (
                                        <div className="table-section" style={{ marginTop: 10 }}>
                                            <Table dataSource={tableDataWithTotal} rowKey="courier_name" pagination={false} size="small" bordered rowClassName={(record) => record.courier_name === "Total" ? "total-row" : "" } columns={columns}
                                            />
                                        </div>
                                    )}
                                </div>
                                            ...
                                            <div className="cutomer-ongoing-bottom-section">
                                                <Row gutter={[16, 0]} justify="space-between" align="middle">
                                                    ...
                                                    <Col span={12} style={{ textAlign: "right" }}>
                                                        <Button type="primary" size="small" style={{backgroundColor: "#faad14",borderColor: "#faad14"}}>
                                                            On Hold
                                                        </Button>
                                                    </Col>
                                                </Row>
