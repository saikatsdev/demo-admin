...
export default function GeneralSetting({ formatText }) {
    ...
    const handleUpdateSingle = async (product) => {
        ...
        formData.append(`items[0][setting_category_id]`, product.category?.id || 1);
    ...
    return (
        <div style={{ padding: '24px 0', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
                <Title level={3} style={{ margin: 0, color: '#1f2937' }}>General Settings</Title>
                <Text type="secondary" style={{ fontSize: '15px' }}>
                    Configure the core operational settings of your platform. Each setting can be updated individually.
                </Text>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {generalSettings.map((product) => product.key && (
                    <Card 
                        key={product.id} 
                        hoverable 
                        style={{ 
                            ...
                            <Col xs={24} md={7}>
                                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                    ...
                                    <Text type="secondary" style={{ marginTop: '8px', fontSize: '14px', lineHeight: '1.5' }}>
                                        {product.instruction || 'Configure this general setting for your platform.'}
                                    </Text>
                                </div>
                            </Col>
