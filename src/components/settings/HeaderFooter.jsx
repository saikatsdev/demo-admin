    ...
    return (
        <div style={{ padding: '24px 0', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
                <Title level={3} style={{ margin: 0, color: '#1f2937' }}>Header & Footer Settings</Title>
                <Text type="secondary" style={{ fontSize: '15px' }}>
                    Configure scripts, meta tags, and global code snippets for your site's header and footer. Each setting can be updated individually.
                </Text>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {filteredHeaderFooterData.map((product) => product.key && (
                    <Card 
                        key={product.id} 
                        hoverable 
                        style={{ 
                            ...
                            <Col xs={24} md={7}>
                                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                    ...
                                    <Text type="secondary" style={{ marginTop: '8px', fontSize: '14px', lineHeight: '1.5' }}>
                                        {product.instruction || 'Configure this setting.'}
                                    </Text>
                                </div>
                            </Col>
                                        ...
                                        case "description":
                                            return (
                                                <textarea 
                                                    ...
                                                    style={{ width: '100%', minHeight: '100px', padding: '12px 16px', borderRadius: '8px', border: '1px solid #d9d9d9', resize: 'vertical', outline: 'none', fontFamily: 'monospace' }}
                                                />
                                            );
