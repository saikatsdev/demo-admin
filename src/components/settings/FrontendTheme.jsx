    ...
    return (
        <div style={{ padding: '24px 0', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
                <Title level={3} style={{ margin: 0, color: '#1f2937' }}>Frontend Theme Settings</Title>
                <Text type="secondary" style={{ fontSize: '15px' }}>
                    Configure colors, layouts, and display options for the public storefront. Each setting can be updated individually.
                </Text>
            </div>
                            ...
                            <Col xs={24} md={7}>
                                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                    ...
                                    <Text type="secondary" style={{ marginTop: '8px', fontSize: '14px', lineHeight: '1.5' }}>
                                        {product.instruction || 'Configure this theme setting.'}
                                    </Text>
                                </div>
                            </Col>
