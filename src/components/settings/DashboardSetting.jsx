...
export default function DashboardSetting({ formatText }) {
    // State
    ...
    return (
        <div style={{ padding: '24px 0', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
                <Title level={3} style={{ margin: 0, color: '#1f2937' }}>Dashboard Settings</Title>
                <Text type="secondary" style={{ fontSize: '15px' }}>
                    Manage and configure your administrative dashboard preferences and visibility options.
                </Text>
            </div>
